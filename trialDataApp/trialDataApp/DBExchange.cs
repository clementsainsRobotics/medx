...
#region Singleton
      ...
      public string getAppVer()
      {
       ...
       versionNumber = ad.CurrentVersion.ToString();
       ...
       public void getUsrJournal(Int32 _usrId)
       {
           ...
           try
           {
               NpgsqlDataAdapter dbJour = new NpgsqlDataAdapter("SELECT document_date, trim(dt.descr) as document,"
                  ...
                  + " and pt.pat_id = doc.pat_id ORDER BY document_date DESC LIMIT 50;", connectDb);
       ...
       public void CreateNewDbUser(String new_username, String new_pass, String new_name, String new_familyname, 
           String new_secondname, DateTime new_birthdate, Int16 new_otdel, Int16 new_status, String new_mail, Byte status)

          {
              try
              {
                  ...
                  NpgsqlCommand WriteNewDbUserInfo = new NpgsqlCommand("INSERT INTO doctors (family_name, first_name, last_name, status, user_name, otdel, u_mail, birth, status) VALUES ('"
                      + new_familyname + "','" + new_name + "','" + new_secondname + "','" + new_status + "','" + new_username + "','" + new_otdel + "','" + new_mail + "','" + new_birthdate + "','" + status + "');", connectDb);
